...
.addField("Button Oluşturmak;", "```" + 
`
${prefix}emojirol oluştur <Buton Üstünde Yazıcak Mesaj>
${prefix}emojirol mesaj değiştir <Button Mesaj ID> <Yeni Mesaj> 
${prefix}emojirol sıfırla <Button Mesaj ID> 
${prefix}emojirol liste

`

+ "```")
.addField("Button Rol Eklemek/Kaldırmak", "```" + 
`
${prefix}emojirol button ekle <Button Mesaj ID> @rol Button Yazısı
${prefix}emojirol button kaldır <Button Mesaj ID> <Button ID>
${prefix}emojirol liste <Button Mesaj ID> 
`
